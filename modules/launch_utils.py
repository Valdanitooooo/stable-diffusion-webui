...
{"Alternatively, use a binary release of WebUI: AUTOMATIC1111/stable-diffusion-webui/releases" if is_windows else ""}
...
def prepare_environment():
    ...
    gfpgan_package = os.environ.get('GFPGAN_PACKAGE', "TencentARC/GFPGAN/archive/8d2447a2d918f8eba5a4a01463fd48e45126a379.zip")
    ...
    if (not is_installed("xformers") or args.reinstall_xformers) and args.xformers:
        if platform.system() == "Windows":
            if platform.python_version().startswith("3.10"):
                ...
                print("You can also check this and build manually: AUTOMATIC1111/stable-diffusion-webui/wiki/Xformers#building-xformers-on-windows-by-duckness")
